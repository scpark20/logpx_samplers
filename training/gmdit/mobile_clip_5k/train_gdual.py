...
from solvers.taylor.extractor.tau_table_extractor import Extractor

noise_schedule = model.get_noise_schedule()
extractor = Extractor(steps=config.n_steps, tau_init=1.0)
...
def do_train_loop(device, writer, solver, optimizer, global_step):
    ...
    for _, batch in enumerate(pbar):
        ...
        optimizer.step()
         ...
         # <<< 여기 추가: tau_x, tau_e를 [0,1]로 투영 >>>
        solver.clamp_tau_params()
