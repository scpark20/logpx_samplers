    ...
    def get_next_sample(
        ...
        if order == 1:
            if self.exact_first:
                ...
                X = xc * first_and_second_x
                E = ec * first_and_second_e
            ...
            if corrector:
                X = X + 0.5 * (xn - xc) * first_and_second_x
                E = E + 0.5 * (en - ec) * first_and_second_e
            else:
                ...
                X = X + 0.5 * (xc - xp)/r_u * first_and_second_x
                E = E + 0.5 * (ec - ep)/r_v * first_and_second_e
