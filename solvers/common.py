    ...
    def model_fn(x, t_continuous):
        ...
        if guidance_tp == "uncond":
            ...
            if (
                ...
                uncond_expanded = unconditional_condition.repeat(batch_size, *([1] * (unconditional_condition.dim() - 1)))
                cond_expanded = condition.repeat(batch_size, *([1] * (condition.dim() - 1)))
                c_in = torch.cat([uncond_expanded, cond_expanded])
